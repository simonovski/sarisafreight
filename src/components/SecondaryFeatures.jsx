...
const features = [
  {
    name: 'Trucking operations',
    description:
      'We have our own fleet of trucks ready to deploy to assist our carriers operations.',
    icon: DeviceArrowIcon,
  },
  {
    name: 'Digital Logistics',
    description:
      'Real-time data of greight movement, driver performance metrics and many other tools to drive eficiencies.',
    icon: DeviceCardsIcon,
  },
  {
    name: 'Carrier network',
    description:
      'Our shared-values with the transportation ecosystem empowers us to provide the highest quaility freight operatos in the industry.',
    icon: DeviceClockIcon,
  },
  {
    name: 'Truck sales & Leasing',
    description:
      'We offer wide randge of truck salse and leasing solutions to help truckers grow and manage their business efficiently.',
    icon: DeviceListIcon,
  },
  {
    name: 'Truck Repair & Maintanance',
    description:
      'When the unpredictable happens, we have the resources to get truck back on the road.',
    icon: DeviceLockIcon,
  },
  {
    name: 'Finance & Insurance',
    description:
      "From factoring to liability protection, we've got our fleets coverd.",
      ...
      <div class="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-2 lg:items-start lg:gap-24 lg:px-8">
          <div class="relative sm:py-16 lg:py-0">
            <div>
              <div>
                <img
                  class="h-11 w-auto bg-rose-100 py-2 px-4 rounded"
                  src="https://www.sarisafreight.com/wp-content/themes/sarisa/assets/images/logo.svg"
                  alt="Your Company"
                />
              </div>
              <div class="mt-20">
                ...
                <div class="mt-6 sm:max-w-xl">
                  ...
                  <h3 class="text-xl font-bold tracking-tight text-gray-600 sm:text-2xl">
                  We empower and strengthen the connection between shippers and carriers.
                  </h3>
                  <p class="mt-6 text-xl text-gray-500">
                  We operate a carrier centric portfolio of businesses, founded under a common equity ownership, operating as integrated organizations. This is how we can scale more rapidly and ultimately provide the most efficient freight network possible.
                  </p>
                </div>
